...
void IPC::writeMessage(std::string message, std::string path)
{
    std::ofstream myFile;
...
void IPC::deleteMessage(size_t posLine, std::string path)
{
    size_t i = 0;
...
void IPC::manageMessage(std::vector<std::string> &order, std::vector<std::string> lineVector, std::pair<std::size_t, std::size_t> stat, std::pair<std::string, std::string> statString)
{
...
std::vector<std::string> IPC::readIPC(std::string nameFile, std::size_t ID)
{
...
void IPC::deleteFile(std::string fileName)
{
