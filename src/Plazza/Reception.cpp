...
std::size_t Reception::assignKitchenID()
{
...
std::size_t Reception::chooseBestFittedKitchen()
{
...
std::size_t Reception::checkInputStatus(std::string command)
{
...
std::size_t Reception::createKitchen()
{
...
void Reception::checkWorkingKitchen()
{

}

void Reception::addKitchenStat(std::size_t kitchenID)
{
...
std::vector<std::string> Reception::manageCommands(std::vector<std::string> &command)
{
...
void Reception::displayReceipts(std::vector<std::string> receipts)
{
    Utils utils;
...
void Reception::updateKitchens(std::vector<std::string> receipts)
{
    Utils utils;
...
void Reception::runReception(std::vector<std::string> &command)
{
    this->manageReceipt();
...
std::string Reception::formatCommand(std::vector<std::string> &command, std::size_t chosenKitchenID)
{
    Utils utils;
...
void Reception::setCookingTime(std::size_t newValue)
{
    this->_cookingTimeMultiplier = newValue;
}

void Reception::setNbCooksPerKitchen(std::size_t newValue)
{
    this->_nbCooksPerKitchen = newValue;
}

void Reception::setTimeReplaceIngredient(std::size_t newValue)
{
    this->_timeReplaceIngredient = newValue;
}

void Reception::deleteFile(std::string fileName)
{
